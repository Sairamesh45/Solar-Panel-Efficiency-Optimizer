...
### Theme Colors
```css
--auth-bg-start: #0b0620
--auth-bg-mid: #1a0f2f
--auth-bg-end: #2f1242

--auth-text-primary: #E9E6FF
--auth-text-muted: #BFB4E6
--auth-text-secondary: #9D8FCC

--auth-accent-start: #8b5cf6
--auth-accent-end: #c08cff
...
--auth-input-focus: rgba(139, 92, 246, 0.3)

--auth-error: #ff6b9d
--auth-success: #4ade80

--focus-ring: 0 0 0 4px var(--auth-input-focus)
```
